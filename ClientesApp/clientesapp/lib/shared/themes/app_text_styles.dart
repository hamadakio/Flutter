...
class TextStyles {
  ...
  static final titleRegularSecondary = GoogleFonts.lexendDeca(
    fontSize: 20,
    fontWeight: FontWeight.w400,
    color: AppColors.secondary,
  );
  static final titleRegularBoldSecondary = GoogleFonts.lexendDeca(
    fontSize: 20,
    fontWeight: FontWeight.w600,
    color: AppColors.secondary,
  );
  ...
  static final input = GoogleFonts.inter(
      fontSize: 15, fontWeight: FontWeight.w700, color: AppColors.input);
